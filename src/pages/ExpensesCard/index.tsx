...
const ExpensesCard = () => { 
    ...
    const [sales, setSales] = useState<{day: string, value: string, reason: string, card?: string}[]>([])
    ...
    async function getDailyBills(){
        ...
        try{
            ...
            const novosGastos: { day: string; value: string; reason: string, card: string}[] = []
